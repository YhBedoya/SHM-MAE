...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default="/home/yvelez/INSIST_SS335/", type=str,  #TODO: data dir
                        help='dataset path') #"/home/yvelez/sacertis/traffic/20211205/"

    parser.add_argument('--output_dir', default='/home/yvelez/SHM-MAE/output_dir_INSIST',
                        help='path where to save, empty for no saving') #/home/yvelez/SHM-MAE/output_dir
    parser.add_argument('--log_dir', default='/home/yvelez/SHM-MAE/output_dir_INSIST',
