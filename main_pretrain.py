...
from util.SHM_DataSet import SHMDataset
...
def get_args_parser():
    ...
    parser.add_argument('--log_dir', default='/content/drive/MyDrive/Data Science and Engineering - PoliTo2/Thesis/models/MAE-SHM/output_dir',
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--num_workers', default=50, type=int) #TODO: 10
