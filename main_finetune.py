...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/home/yvelez/SHM-MAE/output_dir_TE/fine_tuningV4', 
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/home/yvelez/SHM-MAE/output_dir_TE/fine_tuningV4',
