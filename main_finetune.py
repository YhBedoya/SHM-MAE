...
def get_args_parser():
    ...
    # parser.add_argument('--color_jitter', type=float, default=None, metavar='PCT', #TODO: define the data augmentation techniques
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default= '/home/yvelez/SHM-MAE/output_dir_TE/pre-train/checkpoint-199.pth',  #'/home/yvelez/SHM-MAE/output_dir_TE/pre-train/checkpoint-199.pth',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/yvelez/sacertis/traffic/20211206/', type=str, #'/home/yvelez/sacertis/traffic/20211206/'
                        help='dataset path')
    parser.add_argument('--data_path_val', default='/home/yvelez/sacertis/traffic/20211206/', type=str, #'/home/yvelez/sacertis/traffic/20211206/'
                        help='dataset path')
    parser.add_argument('--nb_classes', default=1000, type=int,
                        help='number of the classification types')

    parser.add_argument('--output_dir', default='/home/yvelez/SHM-MAE/output_dir_TE/fine_tuning', #'/home/yvelez/SHM-MAE/output_dir_TE/fine_tuning',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/home/yvelez/SHM-MAE/output_dir_TE/fine_tuning',  #'/home/yvelez/SHM-MAE/output_dir_TE/fine_tuning',
