...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='/content/drive/MyDrive/Data Science and Engineering - PoliTo2/Thesis/models/MAE-SHM/output_dir_TE/checkpoint-199.pth',
